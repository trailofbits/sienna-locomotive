 ...
 * Note that the member names aren't quite right for all the function calls we fill this struct out for.
 * We mix and match as necessary since it's just used as a contiguous region of memory for hashing,
