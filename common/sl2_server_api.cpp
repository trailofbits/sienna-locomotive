...
SL2_EXPORT SL2Response sl2_conn_open(sl2_conn *conn) {
  ...
  pipe =
      CreateFile(FUZZ_SERVER_PATH, GENERIC_READ | GENERIC_WRITE, 0, NULL, OPEN_EXISTING, 0, NULL);
...
SL2_EXPORT
SL2Response sl2_conn_advise_mutation(sl2_conn *conn, sl2_arena *arena,
